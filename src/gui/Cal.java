...
public class Cal extends JPanel {
  /** The currently-interesting year month day */
...
//          setCurSel(new String(Integer.parseInt(num) + "-" 
//+ (monthChoice.getSelectedIndex()+1) + "-" + yearChoice.getSelectedItem().toString()));
          
          selDay = Integer.parseInt(num);
          selMonth = (monthChoice.getSelectedIndex()+1);
          selYear = Integer.parseInt((String) yearChoice.getSelectedItem());
...
//      labs[5][6] is never used and selectable
      b.setBackground(labs[5][6].getBackground());
      b.repaint();
      b.revalidate();
      activeDay = -1;
    }
...
//	  reset active day
  ...
  /**
   * @param selDay the selDay to set
   */
...
//
///**
// * @param curSel the curSel to set
// */
//public void setCurSel(String curSel) {
//	this.curSel = curSel;
//}
